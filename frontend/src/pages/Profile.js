      ...
      <div className='profile'>
        <div className="leftDiv">
          <div className="header">
            ...
            {
             logo=="bLogo" ?  <img src={businessImage} alt="" /> : <div className="binfo">
          ...
          {
            user.role=="admin" &&  <div className="div div2" onClick={()=>navigate("/profile/vendors")}>
            <div className="left">
           ...
           {
            user.role!="customer" &&  <div className="div" onClick={()=>navigate("/profile/store")}>
            <div className="left">
              <InventoryIcon />
           ...
           {
            user.role!="customer" && 
            <div className="div div2" onClick={()=>navigate("/profile/drafts")}>
              <div className="left">
              <ArchiveIcon />
...
<div className="div" onClick={()=>navigate("/profile/account")}>
           ...
           {
            user.role!="customer" &&  <div className="div div2" onClick={()=>navigate("/profile/orders")}>
            <div className="left">
              <LocalShippingIcon />
            ...
            {
              user.role!="customer" && <div className="div " onClick={()=>navigate("/profile/history")}>
              <div className="left">
              <ArchiveIcon />
